...
from .model_utils.llama_for_causal_lm_protein import LlamaForCausalLMProtein ### here
...
def load_model(
    ...
    if model is None and not lazy_load:
        ...
        init_kwargs["pretrained_model_name_or_path"] = model_args.model_name_or_path ### here
        ...
        if model_args.mixture_of_depths == "load":
            ...
            if type(config) in AutoModelForVision2Seq._model_mapping.keys():  # assume built-in models
                ...
                # load_class = AutoModelForCausalLM ### here here
                load_class = LlamaForCausalLMProtein
    ...
    if not lazy_load:
        patch_model(model, tokenizer, model_args, is_trainable, add_valuehead) ### here resize了embed层
